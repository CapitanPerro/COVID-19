...
var Gravatar = {
    ...
    init: function(t, e) {
        ...
        var a = document.cookie.split(";"), r, i;
    ...
    closest: function(t, e) {
        ...
        } while (r !== null && r.nodeType === 1);return null
    },
    ...
    get: function(t) {
        if (-1 != t.indexOf(".")) {
            ...
            if (GProfile.data[parts[0]]) {
                ...
                for (i = 0,
                s = GProfile.data[parts[0]].length; i < s; i++) {
...
function str2binl(t) {
    var e = Array();
    var a = (1 << chrsz) - 1;
    for (var r = 0; r < t.length * chrsz; r += chrsz)
        e[r >> 5] |= (t.charCodeAt(r / chrsz) & a) << r % 32;
    return e
}
function binl2str(t) {
    var e = "";
    var a = (1 << chrsz) - 1;
    for (var r = 0; r < t.length * 32; r += chrsz)
        e += String.fromCharCode(t[r >> 5] >>> r % 32 & a);
    return e
}
function binl2hex(t) {
...
function binl2b64(t) {
    ...
    for (var r = 0; r < t.length * 4; r += 3) {
        ...
        for (var o = 0; o < 4; o++) {
            if (r * 8 + o * 6 > t.length * 32)
                a += b64pad;
            else
                a += e.charAt(i >> 6 * (3 - o) & 63)
        }
    }
    return a
}
